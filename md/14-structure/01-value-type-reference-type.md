...
- string, Classes, Interfaces, Delegates
- Mainly meant for storing complex / large amount of values
- Instances (objects) are stored in **heap**. Heap is only one for entire application. Create heap when program execution start
